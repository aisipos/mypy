...
from mypy.nodes import (
    ...
    CastExpr, RevealLocalsExpr, RevealTypeExpr, TupleExpr, GeneratorExpr, ListComprehension,
    ListExpr, ConditionalExpr, DictExpr, SetExpr, NameExpr, IntExpr, StrExpr, BytesExpr,
